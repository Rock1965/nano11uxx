...
int main(void) {
	...
	//
	myBLE ble;
	ble.advertising(100, -59);	// set adv. interval = 100ms, calibrater tx power = -70dBm
...
// default memory pool
//
static uint8_t mem_pool[DEFAULT_POOL_SIZE-480];	// reduce pool size to increase the global stack
