...
\hline
{\em tx\-Power\-Level} & To indicate the \char`\"{}\-Tx\-Power\-Level\char`\"{} on the advertising message. \\
\hline
{\em conn\-Interval} & To indicate the \char`\"{}connection interval\char`\"{} on the advertising message. \\
\hline
{\em conn\-Timeout} & To indicate the \char`\"{}connection timeout\char`\"{} on the advertising message. \\
\hline
{\em manufacture\-Data} & To indicate the \char`\"{}\-Manufacture Data\char`\"{} on the advertising message. \\
\hline
\end{DoxyParams}
