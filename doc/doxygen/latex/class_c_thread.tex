...
Call the member function to retrieve the task's name. \hypertarget{class_c_thread_ac30b0a1f51549a97b88771692319c0e4}{\index{C\-Thread@{C\-Thread}!get\-Priority@{get\-Priority}}
...
Retrieve the state of thread object (task) \hypertarget{class_c_thread_a4a0f0727be4714cef1e24150a869d403}{\index{C\-Thread@{C\-Thread}!is\-Alive@{is\-Alive}}
...
is\-Alive is to check the thread is in alive (for run-\/loop) \hypertarget{class_c_thread_a51dbe9909ce528b4113d2cc27314e965}{\index{C\-Thread@{C\-Thread}!is\-Suspend@{is\-Suspend}}
...
\end{DoxyReturn}
\hypertarget{class_c_thread_ab2513fd0fcad30e2e6605609c91f1984}{\index{C\-Thread@{C\-Thread}!is\-Thread@{is\-Thread}}
...
Reimplemented from \hyperlink{class_c_object}{C\-Object}.

\hypertarget{class_c_thread_a15041136818470124d097d790d55a6e5}{\index{C\-Thread@{C\-Thread}!kill@{kill}}
...
kill the thread, call the kill the \hyperlink{class_c_thread_a4a0f0727be4714cef1e24150a869d403}{is\-Alive()} will return false \hypertarget{class_c_thread_ac8c53aa8c145fc4ac70fa6d825b95742}{\index{C\-Thread@{C\-Thread}!resume@{resume}}
...
The resume\-All is a static (global) function to resume all suspended tasks. \hypertarget{class_c_thread_a071c3d3b3c19a7bd6a01aca073a9b4d7}{\index{C\-Thread@{C\-Thread}!run@{run}}
...
\hypertarget{class_c_thread_a6b0703ae0cc085a0c0aaa55b6945575b}{\index{C\-Thread@{C\-Thread}!set\-Priority@{set\-Priority}}
...
Example:
    ...
    \}
\end{DoxyCode}
 \hypertarget{class_c_thread_a2c09328581bd4e4a3e9e793f3376a92a}{\index{C\-Thread@{C\-Thread}!suspend\-All@{suspend\-All}}
...
The suspend\-All is a static (globa) function to suspend all running tasks. 
